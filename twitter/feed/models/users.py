...
class Users(Model):
    ...
    """
    def __init__(self, contributors_enabled: bool=None, created_at: str=None, default_profile: bool=None, default_profile_image: bool=None, description: str=None, entities: Entities=None, favorites_count: int=None, follow_request_sent: bool=None, following: bool=None, followers_count: int=None, friends_count: int=None, geo_enabled: bool=None, id: int=None, id_str: str=None, is_translator: bool=None, lang: str=None, listed_count: int=None, location: str=None, name: str=None, notifications: bool=None, profile_background_color: str=None, profile_background_image_url: str=None, profile_background_image_url_https: str=None, profile_background_tile: str=None, profile_banner_url: str=None, profile_image_url: str=None, profile_image_url_https: str=None, profile_link_color: str=None, profile_sidebar_border_color: str=None, profile_sidebar_fill_color: str=None, profile_text_color: str=None, profile_use_background_image: bool=None, protected: bool=None, screen_name: str=None, show_all_inline_media: bool=None, statuses_count: int=None, time_zone: str=None, url: str=None, utc_offset: int=None, verified: bool=None, withheld_in_countries: str=None, withheld_scope: str=None):
        """
